...
DEFAULT_TICKET_STATUS_CHOICES_FLOW = {
    # OPEN_STATUS: (OPEN_STATUS, RESOLVED_STATUS, COMPLETED_STATUS, DUPLICATE_STATUS,),
    # REOPENED_STATUS: (REOPENED_STATUS, RESOLVED_STATUS, COMPLETED_STATUS, DUPLICATE_STATUS,),
    # RESOLVED_STATUS: (REOPENED_STATUS, RESOLVED_STATUS, COMPLETED_STATUS,),
    # COMPLETED_STATUS: (REOPENED_STATUS, COMPLETED_STATUS,),
